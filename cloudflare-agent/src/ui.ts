...
<body>
  ...
  <div class="auth" id="auth">
    ...
    <div class="auth-footer">
      your self-hosted Machina instance<br>
  ...
  <script>
    const API = '/agents/machina-agent';
    ...
    function logout(message) {
      ...
      // Reset chat
      msgs.innerHTML = '<div class="welcome" id="welcome"><h1>Machina</h1><p>remote control</p></div>';
    }
    ...
    function connectWebSocket() {
      ...
      const wsTarget = wsUrl.toString().replace('https://', 'wss://').replace('http://', 'ws://');
      ...
      try {
        ...
        ws.onmessage = (event) => {
          ...
          } catch { /* Invalid WebSocket message, ignore */ }
        };
        ...
        ws.onerror = () => { ws = null; };
      } catch { /* WebSocket connection failed, will retry */ }
    }
    ...
    $('new-btn').addEventListener('click', () => {
      ...
      msgs.innerHTML = '<div class="welcome" id="welcome"><h1>Machina</h1><p>remote control</p><div class="welcome-cmds"><button class="welcome-cmd" data-cmd="what\\'s the volume?">volume</button><button class="welcome-cmd" data-cmd="play music">play</button></div></div>';
